  ...
  const values = [
    {
      icon: "🎯",
      title: "Excellence",
      description: "We strive for perfection in every service we provide, never settling for 'good enough'."
    },
    {
      icon: "🤝",
      title: "Trust",
    ...
    },
    {
      icon: <Rocket/>,
      title: "Innovation",
      description: "Continuously improving our technology and processes to better serve our customers."
    },
    {
      icon: "💚",
      title: "Care",
      description: "Treating every vehicle and customer with the attention and respect they deserve."
    }
  ];
    ...
    <div id='aboutus' className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
              Revolutionizing automotive service with mobile mechanics, cutting-edge technology, 
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              <p className="text-lg leading-relaxed">
                OneTap was born from a simple frustration: why should car troubles disrupt your entire day? 
                Founded in 2019, we set out to bring professional automotive service directly to our customers, 
                wherever they are.
              </p>
              <p className="text-lg leading-relaxed">
                What started as a small team of passionate mechanics has grown into a nationwide network of 
                certified professionals, all united by the mission to make car maintenance convenient, 
                transparent, and stress-free.
              </p>
              <p className="text-lg leading-relaxed">
                Today, we're proud to serve over 50,000 customers across the country, backed by cutting-edge 
                technology and a commitment to excellence that drives everything we do.
              </p>
            </div>
          </div>
          <div className="bg-gradient-to-br from-red-100 to-orange-100 rounded-3xl p-8">
            <div className="text-center">
              <div className="flex justify-center mb-4"><Car size={66}/></div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Mission</h3>
              <p className="text-gray-700 text-lg">
                To make quality automotive service accessible, convenient, and trustworthy for everyone, 
                while empowering skilled mechanics to build successful careers.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="opacity-90">
                We come to your home, office, or wherever you are. No more waiting at repair shops.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="opacity-90">
                Know exactly what you're paying for with upfront, competitive pricing.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="opacity-90">
                All work backed by our comprehensive warranty and satisfaction guarantee.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to Experience RoadRescue?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of satisfied customers who have made the switch to convenient, professional auto service.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => {navigate('/services')}} className="bg-gradient-to-r from-red-600 to-orange-500 text-white px-8 py-4 rounded-xl font-semibold hover:from-red-700 hover:to-orange-600 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Book Service Now
            </button>
            <button onClick={() => {navigate('/support')}} className="border-2 border-red-600 text-red-600 px-8 py-4 rounded-xl font-semibold hover:bg-red-600 hover:text-white transition-all duration-300">
              Contact Us
            </button>
          </div>
          ...
          <div className="mt-8 p-4 bg-red-50 rounded-xl">
            <p className="text-red-600 font-medium">
              ...
              <a href="tel:555-911-AUTO" className="font-bold hover:underline">
                (555) 911-AUTO
              </a>
            </p>
          </div>
