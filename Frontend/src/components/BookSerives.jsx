          ...
          {currentStep === 4 && (
            <div className="p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-xl space-y-6">
                {/* User Details */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 flex items-center"><User className="mr-2 text-red-500" size={20} /> Your Details</h3>
                ...
                {/* Vehicle Details */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 flex items-center"><Car className="mr-2 text-red-500" size={20} /> Vehicle Details</h3>
                  <div className="space-y-2 text-gray-700">
                    <p><strong>Make:</strong> {bookingData.vehicleMake}</p>
                    <p><strong>Model:</strong> {bookingData.vehicleModel}</p>
                    <p><strong>Year:</strong> {bookingData.vehicleYear}</p>
                    {bookingData.vehicleColor && <p><strong>Color:</strong> {bookingData.vehicleColor}</p>}
                    {bookingData.licensePlate && <p><strong>License Plate:</strong> {bookingData.licensePlate}</p>}
                    {bookingData.mileage && <p><strong>Mileage:</strong> {bookingData.mileage}</p>}
                  </div>
                </div>

                {/* Service Details */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 flex items-center"><Calendar className="mr-2 text-red-500" size={20} /> Service & Schedule</h3>
                  <div className="space-y-2 text-gray-700">
                    <p><strong>Service Type:</strong> <span className="font-semibold text-red-600">{bookingData.serviceType}</span></p>
                    <p><strong>Urgency:</strong> {urgencyOptions.find(opt => opt.value === bookingData.urgency)?.label}</p>
                    <p><strong>Preferred Slot:</strong> {bookingData.preferredDate} at {bookingData.preferredTime}</p>
                    {bookingData.alternateDate && bookingData.alternateTime && (
                      <p><strong>Alternate Slot:</strong> {bookingData.alternateDate} at {bookingData.alternateTime}</p>
                    )}
                    {bookingData.problemDescription && (
                      <p><strong>Problem Description:</strong> {bookingData.problemDescription}</p>
                    )}
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside ml-2">
                          {bookingData.additionalServices.map(id => {
                            ...
                            return service ? <li key={id}>{service.name} ({service.price})</li> : null;
                          })}
                        </ul>
                      </div>
                    )}
                ...
                {/* Contact Preferences */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 flex items-center"><Phone className="mr-2 text-red-500" size={20} /> Contact Preferences</h3>
                  <div className="space-y-2 text-gray-700">
                    <p><strong>Preferred Contact:</strong> {bookingData.contactPreference === 'phone' ? 'Phone Call' : 'Email'}</p>
                    <p><strong>Marketing Consent:</strong> {bookingData.marketingConsent ? 'Yes' : 'No'}</p>
                  </div>
                </div>
                ...
                <div className="text-right mt-6">
                  <p className="text-2xl font-bold text-gray-900">
                    Estimated Price: <span className="text-red-600">{bookingData.estimatedPrice || 'N/A'}</span>
                  </p>
              ...
              <div className="mt-6 p-4 bg-yellow-50 border-l-4 border-yellow-500 text-yellow-800 rounded">
                ...
                <p className="text-sm">
                  By clicking "Confirm & Book", you agree to our <a href="#" className="underline text-yellow-900 hover:text-yellow-700">Terms of Service</a> and <a href="#" className="underline text-yellow-900 hover:text-yellow-700">Privacy Policy</a>.
