    ...
    const mockMechanics = [
      {
        ...
        certifications:
          "ASE Certified Master Technician, Honda Service Certification",
        ...
        previousWork:
          "Senior Mechanic at AutoMax Service Center (2019-2024), Junior Technician at City Motors (2018-2019)",
        references:
          "Manager John Doe - AutoMax Service Center: +91-9876543211, Supervisor Sarah Smith - City Motors: +91-9876543212",
        status: "pending",
      ...
      },
      {
        ...
        previousWork:
          "Apprentice at Delhi Auto Works (2022-2024), Trainee at Quick Service Auto (2021-2022)",
        references:
          "Lead Technician Raj Patel - Delhi Auto Works: +91-8765432110",
        status: "approved",
      ...
      },
      {
        ...
        certifications:
          "Master Automotive Technician, Transmission Specialist Certification, Welding Certificate",
        ...
        previousWork:
          "Workshop Owner - Patel Auto Repair (2015-2024), Senior Mechanic at Gujarat Motors (2012-2015)",
        references:
          "Business Partner Kiran Modi: +91-7654321099, Former Manager Deepak Shah - Gujarat Motors: +91-7654321100",
        status: "rejected",
                ...
                {[
                  {
                    key: "pending",
                    label: "Pending",
                    count: mechanics.filter((m) => m.status === "pending")
                      .length,
                  },
                  {
                    key: "approved",
                    label: "Approved",
                    count: mechanics.filter((m) => m.status === "approved")
                      .length,
                  },
                  {
                    key: "rejected",
                    label: "Rejected",
                    count: mechanics.filter((m) => m.status === "rejected")
                      .length,
                  },
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-600 mt-1">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>
                            {mechanic.specialization.slice(0, 2).join(", ")}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="font-medium">
                        {selectedMechanic.emergencyAvailable ? "Yes" : "No"}
                      </p>
                    </div>
                  </div>
                  <div className="mt-3">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium mt-1">
                        {selectedMechanic.previousWork ||
                          "No previous work details provided"}
                      </p>
                    </div>
                    <div>
                      <span className="text-gray-600">References:</span>
                      <p className="font-medium mt-1">
                        {selectedMechanic.references ||
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="font-medium">
                      {new Date(selectedMechanic.appliedAt).toLocaleDateString(
                        "en-US",
                        {
                          year: "numeric",
                          month: "long",
